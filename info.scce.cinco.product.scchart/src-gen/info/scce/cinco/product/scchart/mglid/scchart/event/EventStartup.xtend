...
class EventStartup implements IStartup {
	...
	def static void subscribe() {
		...
		SuspensionEvent.instance.subscribe
		...
		InitialFinalSCChartRefereceEvent.instance.subscribe
	...
	def static void unsubscribe() {
		...
		SuspensionEvent.instance.unsubscribe
		...
		InitialFinalSCChartRefereceEvent.instance.unsubscribe
