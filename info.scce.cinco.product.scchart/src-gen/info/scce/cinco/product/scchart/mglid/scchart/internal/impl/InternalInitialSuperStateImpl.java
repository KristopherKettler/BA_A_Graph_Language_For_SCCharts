 ...
 * @generated
 */
public class InternalInitialSuperStateImpl extends InternalSuperStateImpl implements InternalInitialSuperState {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected InternalInitialSuperStateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalInitialSuperState();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == InternalNode.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_NODE___GET_OUTGOING_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_OUTGOING_CONSTRAINTS;
				case graphmodel.internal.InternalPackage.INTERNAL_NODE___GET_INCOMING_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INCOMING_CONSTRAINTS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == InternalModelElementContainer.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_MODEL_ELEMENT_CONTAINER___GET_CONTAINMENT_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONTAINMENT_CONSTRAINTS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == InternalContainer.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_CONTAINER___GET_CONTAINMENT_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONTAINMENT_CONSTRAINTS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == InternalSuperState.class) {
			switch (baseOperationID) {
				case InternalPackage.INTERNAL_SUPER_STATE___GET_CONTAINMENT_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONTAINMENT_CONSTRAINTS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INCOMING_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INCOMING_CONSTRAINTS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_OUTGOING_CONSTRAINTS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_OUTGOING_CONSTRAINTS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_ROOT_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_ROOT_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SUPER_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SUPER_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SUPER_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_FINAL_SUPER_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SUPER_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SIMPLE_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SIMPLE_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_FINAL_STATE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_STATE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_CONNECTOR_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONNECTOR_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SC_CHART_REFERECE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_PREDECESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SUPER_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SUPER_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SUPER_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_FINAL_SUPER_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SUPER_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SIMPLE_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SIMPLE_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_FINAL_STATE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_STATE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_CONNECTOR_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONNECTOR_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SC_CHART_REFERECE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_SUCCESSORS;
				case InternalPackage.INTERNAL_SUPER_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_SUCCESSORS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONTAINMENT_CONSTRAINTS:
				return getContainmentConstraints();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INCOMING_CONSTRAINTS:
				return getIncomingConstraints();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_OUTGOING_CONSTRAINTS:
				return getOutgoingConstraints();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_ROOT_STATE_PREDECESSORS:
				return getRootStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SUPER_STATE_PREDECESSORS:
				return getSuperStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SUPER_STATE_PREDECESSORS:
				return getInitialSuperStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SUPER_STATE_PREDECESSORS:
				return getFinalSuperStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SUPER_STATE_PREDECESSORS:
				return getInitialFinalSuperStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SIMPLE_STATE_PREDECESSORS:
				return getSimpleStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_STATE_PREDECESSORS:
				return getInitialStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_STATE_PREDECESSORS:
				return getFinalStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_STATE_PREDECESSORS:
				return getInitialFinalStatePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONNECTOR_PREDECESSORS:
				return getConnectorPredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SC_CHART_REFERECE_PREDECESSORS:
				return getSCChartReferecePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_PREDECESSORS:
				return getInitialSCChartReferecePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_PREDECESSORS:
				return getFinalSCChartReferecePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_PREDECESSORS:
				return getInitialFinalSCChartReferecePredecessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SUPER_STATE_SUCCESSORS:
				return getSuperStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SUPER_STATE_SUCCESSORS:
				return getInitialSuperStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SUPER_STATE_SUCCESSORS:
				return getFinalSuperStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SUPER_STATE_SUCCESSORS:
				return getInitialFinalSuperStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SIMPLE_STATE_SUCCESSORS:
				return getSimpleStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_STATE_SUCCESSORS:
				return getInitialStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_STATE_SUCCESSORS:
				return getFinalStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_STATE_SUCCESSORS:
				return getInitialFinalStateSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_CONNECTOR_SUCCESSORS:
				return getConnectorSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_SC_CHART_REFERECE_SUCCESSORS:
				return getSCChartRefereceSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_SC_CHART_REFERECE_SUCCESSORS:
				return getInitialSCChartRefereceSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_FINAL_SC_CHART_REFERECE_SUCCESSORS:
				return getFinalSCChartRefereceSuccessors();
			case InternalPackage.INTERNAL_INITIAL_SUPER_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_SUCCESSORS:
				return getInitialFinalSCChartRefereceSuccessors();
		}
		return super.eInvoke(operationID, arguments);
	}

} //InternalInitialSuperStateImpl
