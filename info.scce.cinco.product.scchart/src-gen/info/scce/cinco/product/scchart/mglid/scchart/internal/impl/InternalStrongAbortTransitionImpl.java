 ...
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalStrongAbortTransitionImpl#getCount_delay <em>Count delay</em>}</li>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.internal.impl.InternalStrongAbortTransitionImpl#isImmediate <em>Immediate</em>}</li>
...
public class InternalStrongAbortTransitionImpl extends InternalAbstractTransitionImpl implements InternalStrongAbortTransition {
	 ...
	 * @generated
	 */
	protected InternalStrongAbortTransitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalStrongAbortTransition();
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__CONDITION, oldCondition, condition));
	}
	...
	public void setCount_delay(String newCount_delay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__COUNT_DELAY, oldCount_delay, count_delay));
	}
	...
	public void setImmediate(boolean newImmediate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__IMMEDIATE, oldImmediate, immediate));
	}
	...
	public void setEffect(String newEffect) {
		...
		effect = newEffect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__EFFECT, oldEffect, effect));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__CONDITION:
				return getCondition();
			case InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__COUNT_DELAY:
				return getCount_delay();
			case InternalPackage.INTERNAL_STRONG_ABORT_TRANSITION__IMMEDIATE:
				return isImmediate();
...
} //InternalStrongAbortTransitionImpl
