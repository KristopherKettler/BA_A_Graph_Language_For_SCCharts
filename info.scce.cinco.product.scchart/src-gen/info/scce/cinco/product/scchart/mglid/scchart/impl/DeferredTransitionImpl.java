	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.DEFERRED_TRANSITION___RECONNECT_SOURCE__INITIALSUPERSTATE:
				...
				return null;
			case ScchartPackage.DEFERRED_TRANSITION___CAN_RECONNECT_SOURCE__INITIALFINALSCCHARTREFERECE:
				return canReconnectSource((InitialFinalSCChartReferece)arguments.get(0));
			case ScchartPackage.DEFERRED_TRANSITION___RECONNECT_SOURCE__INITIALFINALSCCHARTREFERECE:
			...
			case ScchartPackage.DEFERRED_TRANSITION___RECONNECT_TARGET__SCCHARTREFERECE:
				...
				return null;
			case ScchartPackage.DEFERRED_TRANSITION___CAN_RECONNECT_TARGET__INITIALFINALSCCHARTREFERECE:
				return canReconnectTarget((InitialFinalSCChartReferece)arguments.get(0));
			case ScchartPackage.DEFERRED_TRANSITION___RECONNECT_TARGET__INITIALFINALSCCHARTREFERECE:
