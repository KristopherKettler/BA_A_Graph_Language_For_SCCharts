 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.impl.RegionImpl#getInternalElement <em>Internal Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegionImpl extends ModelElementContainerImpl implements Region {
	...
	public InternalRegion getInternalRegion() {
		return (info.scce.cinco.product.scchart.mglid.scchart.internal.InternalRegion) getInternalElement();
	}
	...
	public void preDelete() {
		// event.pre.delete.info_scce_cinco_product_scchart_mglid_scchart_Region
		de.jabc.cinco.meta.plugin.event.api.payload.PreDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region> eventPayload = new de.jabc.cinco.meta.plugin.event.api.payload.PreDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>(this);
		de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PreDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void> eventContext = new de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PreDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void>("event.pre.delete.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
	...
	public Runnable getPostDeleteEvent() {
		// event.post.delete.info_scce_cinco_product_scchart_mglid_scchart_Region
		de.jabc.cinco.meta.plugin.event.api.payload.PostDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region> eventPayload = new de.jabc.cinco.meta.plugin.event.api.payload.PostDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>(this);
		de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PostDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Runnable> eventContext = new de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PostDeletePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Runnable>("event.post.delete.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
		de.jabc.cinco.meta.core.event.hub.EventHub.getInstance().notifyFirst(eventContext);
	 ...
	 */
	@Override
	public EList<InitialFinalState> getInitialFinalStates() {
		return getModelElements(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState.class);
	}
	 ...
	 */
	@Override
	public boolean canNewInitialFinalState() {
		return this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState.class);
	}
	 ...
	 */
	@Override
	public InitialFinalState newInitialFinalState(final int x, final int y) {
		return newInitialFinalState(x, y, -1, -1);
	}
	 ...
	 */
	@Override
	public InitialFinalState newInitialFinalState(final String id, final int x, final int y) {
		return newInitialFinalState(x, y, -1, -1);
	}
	 ...
	 */
	@Override
	public InitialFinalState newInitialFinalState(final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialFinalState((graphmodel.internal.InternalModelElementContainer) this.getInternalElement());
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			node.move(x, y);
			node.resize(width, height);
			return node;
		} else throw new java.lang.RuntimeException(
			java.lang.String.format("Cannot add node %s to %s", info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState.class, this.getClass()));
	 ...
	 */
	@Override
	public InitialFinalState newInitialFinalState(final String id, final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialFinalState node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialFinalState((graphmodel.internal.InternalModelElementContainer) this.getInternalElement());
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			node.move(x, y);
	 ...
	 */
	@Override
	public EList<InitialFinalSuperState> getInitialFinalSuperStates() {
		return getModelElements(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState.class);
	}
	 ...
	 */
	@Override
	public boolean canNewInitialFinalSuperState() {
		return this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState.class);
	}
	 ...
	 */
	@Override
	public InitialFinalSuperState newInitialFinalSuperState(final int x, final int y) {
		return newInitialFinalSuperState(x, y, -1, -1);
	}
	 ...
	 */
	@Override
	public InitialFinalSuperState newInitialFinalSuperState(final String id, final int x, final int y) {
		return newInitialFinalSuperState(x, y, -1, -1);
	}
	 ...
	 */
	@Override
	public InitialFinalSuperState newInitialFinalSuperState(final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialFinalSuperState((graphmodel.internal.InternalModelElementContainer) this.getInternalElement());
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			node.move(x, y);
			node.resize(width, height);
			return node;
		} else throw new java.lang.RuntimeException(
			java.lang.String.format("Cannot add node %s to %s", info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState.class, this.getClass()));
	 ...
	 */
	@Override
	public InitialFinalSuperState newInitialFinalSuperState(final String id, final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSuperState node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialFinalSuperState((graphmodel.internal.InternalModelElementContainer) this.getInternalElement());
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			node.move(x, y);
	 ...
	 */
	@Override
	public EList<InitialSuperState> getInitialSuperStates() {
		return getModelElements(info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState.class);
	}
	 ...
	 */
	@Override
	public boolean canNewInitialSuperState() {
		return this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState.class);
	}
	 ...
	 */
	@Override
	public InitialSuperState newInitialSuperState(final int x, final int y) {
		return newInitialSuperState(x, y, -1, -1);
	}
	 ...
	 */
	@Override
	public InitialSuperState newInitialSuperState(final String id, final int x, final int y) {
		return newInitialSuperState(x, y, -1, -1);
	}
	 ...
	 */
	@Override
	public InitialSuperState newInitialSuperState(final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialSuperState((graphmodel.internal.InternalModelElementContainer) this.getInternalElement());
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			node.move(x, y);
			node.resize(width, height);
			return node;
		} else throw new java.lang.RuntimeException(
			java.lang.String.format("Cannot add node %s to %s", info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState.class, this.getClass()));
	 ...
	 */
	@Override
	public InitialSuperState newInitialSuperState(final String id, final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialSuperState node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialSuperState((graphmodel.internal.InternalModelElementContainer) this.getInternalElement());
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			node.move(x, y);
	 ...
	 */
	@Override
	public EList<InitialFinalSCChartReferece> getInitialFinalSCChartRefereces() {
		return getModelElements(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSCChartReferece.class);
	}
	 ...
	 */
	@Override
	public boolean canNewInitialFinalSCChartReferece() {
		return this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSCChartReferece.class);
	}
	 ...
	 */
	@Override
	public InitialFinalSCChartReferece newInitialFinalSCChartReferece(final EObject reference, final int x, final int y) {
		return newInitialFinalSCChartReferece(reference,x,y,-1,-1);
	}
	 ...
	 */
	@Override
	public InitialFinalSCChartReferece newInitialFinalSCChartReferece(final EObject reference, final String id, final int x, final int y) {
		return newInitialFinalSCChartReferece(reference,x,y,-1,-1);
	}
	 ...
	 */
	@Override
	public InitialFinalSCChartReferece newInitialFinalSCChartReferece(final EObject reference, final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSCChartReferece.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSCChartReferece node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialFinalSCChartReferece();
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalInitialFinalSCChartReferece) node.getInternalElement())
				.setLibraryComponentUID(org.eclipse.emf.ecore.util.EcoreUtil.getID(reference));
			node.move(x, y);
			node.resize(width, height);
			info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.postCreates(node);
			...
			java.lang.String.format("Cannot add node %s to %s", InitialFinalSCChartReferece.class, this.getClass()));
	 ...
	 */
	@Override
	public InitialFinalSCChartReferece newInitialFinalSCChartReferece(final EObject reference, final String id, final int x, final int y, final int width, final int height) {
		if (this.canContain(info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSCChartReferece.class)) {
			info.scce.cinco.product.scchart.mglid.scchart.InitialFinalSCChartReferece node = info.scce.cinco.product.scchart.mglid.factory.SCChartFactory.eINSTANCE.createInitialFinalSCChartReferece();
			this.getInternalContainerElement().getModelElements().add(node.getInternalElement());
			((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalInitialFinalSCChartReferece) node.getInternalElement())
	...
	public void preMove(final ModelElementContainer newContainer, final int newX, final int newY) {
		// event.pre.move.info_scce_cinco_product_scchart_mglid_scchart_Region
		de.jabc.cinco.meta.plugin.event.api.payload.PreMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region> eventPayload = new de.jabc.cinco.meta.plugin.event.api.payload.PreMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>(this, newContainer, newX, newY);
		de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PreMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void> eventContext = new de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PreMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void>("event.pre.move.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
		de.jabc.cinco.meta.core.event.hub.EventHub.getInstance().notifyFirst(eventContext);
	...
	public void postMove(final ModelElementContainer source, final ModelElementContainer target, final int x, final int y, final int deltaX, final int deltaY) {
		// event.post.move.info_scce_cinco_product_scchart_mglid_scchart_Region
		de.jabc.cinco.meta.plugin.event.api.payload.PostMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region> eventPayload = new de.jabc.cinco.meta.plugin.event.api.payload.PostMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>(this, source, x - deltaX, y - deltaY);
		de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PostMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void> eventContext = new de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PostMovePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void>("event.post.move.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
		de.jabc.cinco.meta.core.event.hub.EventHub.getInstance().notifyFirst(eventContext);
	...
	public void preResize(final int newWidth, final int newHeight, final int newX, final int newY, final Direction direction) {
		// event.pre.resize.info_scce_cinco_product_scchart_mglid_scchart_Region
		de.jabc.cinco.meta.plugin.event.api.payload.PreResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region> eventPayload = new de.jabc.cinco.meta.plugin.event.api.payload.PreResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>(this, newWidth, newHeight, newX, newY, direction);
		de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PreResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void> eventContext = new de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PreResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void>("event.pre.resize.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
		de.jabc.cinco.meta.core.event.hub.EventHub.getInstance().notifyFirst(eventContext);
	...
	public void postResize(final int oldWidth, final int oldHeight, final int oldX, final int oldY, final Direction direction) {
		// event.post.resize.info_scce_cinco_product_scchart_mglid_scchart_Region
		de.jabc.cinco.meta.plugin.event.api.payload.PostResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region> eventPayload = new de.jabc.cinco.meta.plugin.event.api.payload.PostResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>(this, oldWidth, oldHeight, oldX, oldY, direction);
		de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PostResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void> eventContext = new de.jabc.cinco.meta.core.event.hub.impl.PayloadContext<de.jabc.cinco.meta.plugin.event.api.payload.PostResizePayload<info.scce.cinco.product.scchart.mglid.scchart.Region>, java.lang.Void>("event.post.resize.info_scce_cinco_product_scchart_mglid_scchart_Region", eventPayload);
		de.jabc.cinco.meta.core.event.hub.EventHub.getInstance().notifyFirst(eventContext);
	...
	public boolean canMoveTo(final RootState rootState, final int x, final int y) {
		return rootState.canContain(info.scce.cinco.product.scchart.mglid.scchart.Region.class);
	}
	...
	public boolean canMoveTo(final SuperState superState, final int x, final int y) {
		return superState.canContain(info.scce.cinco.product.scchart.mglid.scchart.Region.class);
	}
	...
	public boolean canMoveTo(final InitialSuperState initialSuperState, final int x, final int y) {
		return initialSuperState.canContain(info.scce.cinco.product.scchart.mglid.scchart.Region.class);
	}
	...
	public boolean canMoveTo(final FinalSuperState finalSuperState, final int x, final int y) {
		return finalSuperState.canContain(info.scce.cinco.product.scchart.mglid.scchart.Region.class);
	}
	...
	public boolean canMoveTo(final InitialFinalSuperState initialFinalSuperState, final int x, final int y) {
		return initialFinalSuperState.canContain(info.scce.cinco.product.scchart.mglid.scchart.Region.class);
	}
	...
	public RegionView getRegionView() {
		RegionView regionView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createRegionView();
		regionView.setInternalRegion((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalRegion)getInternalElement());
		return regionView;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.REGION___GET_INITIAL_FINAL_STATES:
				return getInitialFinalStates();
			case ScchartPackage.REGION___CAN_NEW_INITIAL_FINAL_STATE:
				return canNewInitialFinalState();
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_STATE__INT_INT:
				return newInitialFinalState((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_STATE__STRING_INT_INT:
				return newInitialFinalState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_STATE__INT_INT_INT_INT:
				return newInitialFinalState((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_STATE__STRING_INT_INT_INT_INT:
				return newInitialFinalState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4));
			case ScchartPackage.REGION___GET_INITIAL_FINAL_SUPER_STATES:
				return getInitialFinalSuperStates();
			case ScchartPackage.REGION___CAN_NEW_INITIAL_FINAL_SUPER_STATE:
				return canNewInitialFinalSuperState();
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SUPER_STATE__INT_INT:
				return newInitialFinalSuperState((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SUPER_STATE__STRING_INT_INT:
				return newInitialFinalSuperState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SUPER_STATE__INT_INT_INT_INT:
				return newInitialFinalSuperState((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SUPER_STATE__STRING_INT_INT_INT_INT:
				return newInitialFinalSuperState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4));
			case ScchartPackage.REGION___GET_INITIAL_SUPER_STATES:
				return getInitialSuperStates();
			case ScchartPackage.REGION___CAN_NEW_INITIAL_SUPER_STATE:
				return canNewInitialSuperState();
			case ScchartPackage.REGION___NEW_INITIAL_SUPER_STATE__INT_INT:
				return newInitialSuperState((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ScchartPackage.REGION___NEW_INITIAL_SUPER_STATE__STRING_INT_INT:
				return newInitialSuperState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.REGION___NEW_INITIAL_SUPER_STATE__INT_INT_INT_INT:
				return newInitialSuperState((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3));
			case ScchartPackage.REGION___NEW_INITIAL_SUPER_STATE__STRING_INT_INT_INT_INT:
				return newInitialSuperState((String)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4));
			case ScchartPackage.REGION___GET_INITIAL_FINAL_SC_CHART_REFERECES:
				return getInitialFinalSCChartRefereces();
			case ScchartPackage.REGION___CAN_NEW_INITIAL_FINAL_SC_CHART_REFERECE:
				return canNewInitialFinalSCChartReferece();
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SC_CHART_REFERECE__EOBJECT_INT_INT:
				return newInitialFinalSCChartReferece((EObject)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SC_CHART_REFERECE__EOBJECT_STRING_INT_INT:
				return newInitialFinalSCChartReferece((EObject)arguments.get(0), (String)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SC_CHART_REFERECE__EOBJECT_INT_INT_INT_INT:
				return newInitialFinalSCChartReferece((EObject)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4));
			case ScchartPackage.REGION___NEW_INITIAL_FINAL_SC_CHART_REFERECE__EOBJECT_STRING_INT_INT_INT_INT:
				return newInitialFinalSCChartReferece((EObject)arguments.get(0), (String)arguments.get(1), (Integer)arguments.get(2), (Integer)arguments.get(3), (Integer)arguments.get(4), (Integer)arguments.get(5));
			...
			case ScchartPackage.REGION___SMOVE_TO__SUPERSTATE_INT_INT:
				...
				return null;
			case ScchartPackage.REGION___CAN_MOVE_TO__INITIALSUPERSTATE_INT_INT:
				return canMoveTo((InitialSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.REGION___MOVE_TO__INITIALSUPERSTATE_INT_INT:
				moveTo((InitialSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.REGION___SMOVE_TO__INITIALSUPERSTATE_INT_INT:
			...
			case ScchartPackage.REGION___SMOVE_TO__FINALSUPERSTATE_INT_INT:
				...
				return null;
			case ScchartPackage.REGION___CAN_MOVE_TO__INITIALFINALSUPERSTATE_INT_INT:
				return canMoveTo((InitialFinalSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ScchartPackage.REGION___MOVE_TO__INITIALFINALSUPERSTATE_INT_INT:
				moveTo((InitialFinalSuperState)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ScchartPackage.REGION___SMOVE_TO__INITIALFINALSUPERSTATE_INT_INT:
