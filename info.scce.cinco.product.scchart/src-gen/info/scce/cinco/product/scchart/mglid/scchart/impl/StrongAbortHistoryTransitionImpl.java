...
import info.scce.cinco.product.scchart.mglid.scchart.views.StrongAbortHistoryTransitionView;
...
public class StrongAbortHistoryTransitionImpl extends AbstractTransitionImpl implements StrongAbortHistoryTransition {
	...
	public StrongAbortHistoryTransitionView getStrongAbortHistoryTransitionView() {
		StrongAbortHistoryTransitionView strongAbortHistoryTransitionView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createStrongAbortHistoryTransitionView();
		strongAbortHistoryTransitionView.setInternalStrongAbortHistoryTransition((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalStrongAbortHistoryTransition)getInternalElement());
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___SET_DEEP_HISTORY__BOOLEAN:
				...
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___IS_IMMEDIATE:
				return isImmediate();
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___SET_IMMEDIATE__BOOLEAN:
			...
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__ROOTSTATE:
				...
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__FINALSCCHARTREFERECE:
				return canReconnectSource((FinalSCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__FINALSCCHARTREFERECE:
			...
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__FINALSUPERSTATE:
				...
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__INITIALFINALSUPERSTATE:
				return canReconnectSource((InitialFinalSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__INITIALFINALSUPERSTATE:
				reconnectSource((InitialFinalSuperState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__INITIALSUPERSTATE:
				return canReconnectSource((InitialSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__INITIALSUPERSTATE:
				reconnectSource((InitialSuperState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__SCCHARTREFERECE:
				return canReconnectSource((SCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__SCCHARTREFERECE:
				reconnectSource((SCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__INITIALFINALSCCHARTREFERECE:
				return canReconnectSource((InitialFinalSCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__INITIALFINALSCCHARTREFERECE:
				reconnectSource((InitialFinalSCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__INITIALSCCHARTREFERECE:
				return canReconnectSource((InitialSCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_SOURCE__INITIALSCCHARTREFERECE:
				reconnectSource((InitialSCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_TARGET__FINALSCCHARTREFERECE:
				return canReconnectTarget((FinalSCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__FINALSCCHARTREFERECE:
			...
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__FINALSUPERSTATE:
				...
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_TARGET__INITIALFINALSUPERSTATE:
				return canReconnectTarget((InitialFinalSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__INITIALFINALSUPERSTATE:
				reconnectTarget((InitialFinalSuperState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_TARGET__INITIALSUPERSTATE:
				return canReconnectTarget((InitialSuperState)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__INITIALSUPERSTATE:
				reconnectTarget((InitialSuperState)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_TARGET__SCCHARTREFERECE:
				return canReconnectTarget((SCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__SCCHARTREFERECE:
				reconnectTarget((SCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_TARGET__INITIALFINALSCCHARTREFERECE:
				return canReconnectTarget((InitialFinalSCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__INITIALFINALSCCHARTREFERECE:
				reconnectTarget((InitialFinalSCChartReferece)arguments.get(0));
				return null;
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___CAN_RECONNECT_TARGET__INITIALSCCHARTREFERECE:
				return canReconnectTarget((InitialSCChartReferece)arguments.get(0));
			case ScchartPackage.STRONG_ABORT_HISTORY_TRANSITION___RECONNECT_TARGET__INITIALSCCHARTREFERECE:
