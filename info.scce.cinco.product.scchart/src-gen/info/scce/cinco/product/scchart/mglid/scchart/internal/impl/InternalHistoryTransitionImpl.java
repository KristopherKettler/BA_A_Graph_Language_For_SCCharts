 ...
 * @generated
 */
public class InternalHistoryTransitionImpl extends InternalAbstractTransitionImpl implements InternalHistoryTransition {
	/**
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalHistoryTransition();
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_HISTORY_TRANSITION__CONDITION, oldCondition, condition));
	}
	...
	public void setCount_delay(String newCount_delay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_HISTORY_TRANSITION__COUNT_DELAY, oldCount_delay, count_delay));
	}
	...
	public void setEffect(String newEffect) {
		...
		effect = newEffect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_HISTORY_TRANSITION__EFFECT, oldEffect, effect));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_HISTORY_TRANSITION__CONDITION:
				return getCondition();
			case InternalPackage.INTERNAL_HISTORY_TRANSITION__COUNT_DELAY:
