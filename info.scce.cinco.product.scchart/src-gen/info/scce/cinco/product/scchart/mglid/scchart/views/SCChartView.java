 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.scchart.mglid.scchart.views.SCChartView#getInternalSCChart <em>Internal SC Chart</em>}</li>
 * </ul>
 *
 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getSCChartView()
 * @model
 * @generated
 */
public interface SCChartView extends EObject {
	 ...
	 * @see info.scce.cinco.product.scchart.mglid.scchart.views.ViewsPackage#getSCChartView_InternalSCChart()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link info.scce.cinco.product.scchart.mglid.scchart.views.SCChartView#getInternalSCChart <em>Internal SC Chart</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
