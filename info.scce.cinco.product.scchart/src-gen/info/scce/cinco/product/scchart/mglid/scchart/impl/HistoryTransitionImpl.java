...
public class HistoryTransitionImpl extends AbstractTransitionImpl implements HistoryTransition {
	...
	protected EClass eStaticClass() {
		return ScchartPackage.eINSTANCE.getHistoryTransition();
	}
	...
	public InternalHistoryTransition getInternalHistoryTransition() {
		return (info.scce.cinco.product.scchart.mglid.scchart.internal.InternalHistoryTransition) getInternalElement();
	}
	 ...
	 */
	@Override
	public boolean isExactlyHistoryTransition() {
		return true;
	}
	 ...
	 */
	@Override
	public HistoryTransitionView getHistoryTransitionView() {
		HistoryTransitionView historyTransitionView = info.scce.cinco.product.scchart.mglid.scchart.views.ViewsFactory.eINSTANCE.createHistoryTransitionView();
		historyTransitionView.setInternalHistoryTransition((info.scce.cinco.product.scchart.mglid.scchart.internal.InternalHistoryTransition)getInternalElement());
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == IdentifiableElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___PRE_SAVE: return ScchartPackage.HISTORY_TRANSITION___PRE_SAVE;
				case GraphmodelPackage.IDENTIFIABLE_ELEMENT___POST_SAVE: return ScchartPackage.HISTORY_TRANSITION___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == ModelElement.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.MODEL_ELEMENT___GET_ROOT_ELEMENT: return ScchartPackage.HISTORY_TRANSITION___GET_ROOT_ELEMENT;
				case GraphmodelPackage.MODEL_ELEMENT___PRE_SAVE: return ScchartPackage.HISTORY_TRANSITION___PRE_SAVE;
				case GraphmodelPackage.MODEL_ELEMENT___POST_SAVE: return ScchartPackage.HISTORY_TRANSITION___POST_SAVE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == Edge.class) {
			switch (baseOperationID) {
				case GraphmodelPackage.EDGE___GET_SOURCE_ELEMENT: return ScchartPackage.HISTORY_TRANSITION___GET_SOURCE_ELEMENT;
				case GraphmodelPackage.EDGE___GET_TARGET_ELEMENT: return ScchartPackage.HISTORY_TRANSITION___GET_TARGET_ELEMENT;
				case GraphmodelPackage.EDGE___GET_POST_DELETE_FUNCTION: return ScchartPackage.HISTORY_TRANSITION___GET_POST_DELETE_FUNCTION;
				case GraphmodelPackage.EDGE___GET_POST_DELETE_EVENT: return ScchartPackage.HISTORY_TRANSITION___GET_POST_DELETE_EVENT;
				case GraphmodelPackage.EDGE___PRE_DELETE: return ScchartPackage.HISTORY_TRANSITION___PRE_DELETE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case ScchartPackage.HISTORY_TRANSITION___IS_EXACTLY_HISTORY_TRANSITION:
				return isExactlyHistoryTransition();
			case ScchartPackage.HISTORY_TRANSITION___PRE_DELETE:
				preDelete();
				return null;
			case ScchartPackage.HISTORY_TRANSITION___GET_POST_DELETE_FUNCTION:
				return getPostDeleteFunction();
			case ScchartPackage.HISTORY_TRANSITION___GET_POST_DELETE_EVENT:
				return getPostDeleteEvent();
			case ScchartPackage.HISTORY_TRANSITION___PRE_SAVE:
				preSave();
				return null;
			case ScchartPackage.HISTORY_TRANSITION___POST_SAVE:
				postSave();
				return null;
			case ScchartPackage.HISTORY_TRANSITION___GET_ROOT_ELEMENT:
				return getRootElement();
			case ScchartPackage.HISTORY_TRANSITION___GET_SOURCE_ELEMENT:
			...
			case ScchartPackage.HISTORY_TRANSITION___RECONNECT_SOURCE__FINALSUPERSTATE:
			...
			case ScchartPackage.HISTORY_TRANSITION___RECONNECT_SOURCE__INITIALSUPERSTATE:
				...
				return null;
			case ScchartPackage.HISTORY_TRANSITION___CAN_RECONNECT_SOURCE__INITIALFINALSCCHARTREFERECE:
				return canReconnectSource((InitialFinalSCChartReferece)arguments.get(0));
			case ScchartPackage.HISTORY_TRANSITION___RECONNECT_SOURCE__INITIALFINALSCCHARTREFERECE:
			...
			case ScchartPackage.HISTORY_TRANSITION___RECONNECT_TARGET__FINALSUPERSTATE:
			...
			case ScchartPackage.HISTORY_TRANSITION___RECONNECT_TARGET__SCCHARTREFERECE:
				...
				return null;
			case ScchartPackage.HISTORY_TRANSITION___CAN_RECONNECT_TARGET__INITIALFINALSCCHARTREFERECE:
				return canReconnectTarget((InitialFinalSCChartReferece)arguments.get(0));
			case ScchartPackage.HISTORY_TRANSITION___RECONNECT_TARGET__INITIALFINALSCCHARTREFERECE:
