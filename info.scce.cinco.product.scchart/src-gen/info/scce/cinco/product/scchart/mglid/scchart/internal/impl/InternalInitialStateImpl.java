...
public class InternalInitialStateImpl extends InternalSimpleStateImpl implements InternalInitialState {
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalInitialState();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		...
		if (baseClass == InternalSimpleState.class) {
			switch (baseOperationID) {
				...
				case InternalPackage.INTERNAL_SIMPLE_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_PREDECESSORS: return InternalPackage.INTERNAL_INITIAL_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_PREDECESSORS;
				...
				case InternalPackage.INTERNAL_SIMPLE_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_SUCCESSORS: return InternalPackage.INTERNAL_INITIAL_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_SUCCESSORS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case InternalPackage.INTERNAL_INITIAL_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_PREDECESSORS:
			...
			case InternalPackage.INTERNAL_INITIAL_STATE___GET_INITIAL_FINAL_SC_CHART_REFERECE_SUCCESSORS:
