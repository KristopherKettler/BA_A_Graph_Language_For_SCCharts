...
public class InternalRegionImpl extends InternalContainerImpl implements InternalRegion {
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalRegion();
	}
	...
	public EList<ContainmentConstraint> getContainmentConstraints() {
		...
		constraints.add(new ContainmentConstraint(0,-1,info.scce.cinco.product.scchart.mglid.scchart.FinalSuperState.class));
