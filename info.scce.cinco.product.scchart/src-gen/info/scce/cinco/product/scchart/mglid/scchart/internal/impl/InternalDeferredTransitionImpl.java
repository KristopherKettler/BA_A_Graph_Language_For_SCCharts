 ...
 * @generated
 */
public class InternalDeferredTransitionImpl extends InternalAbstractTransitionImpl implements InternalDeferredTransition {
	/**
	 ...
	 * @generated
	 */
	protected InternalDeferredTransitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.eINSTANCE.getInternalDeferredTransition();
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_DEFERRED_TRANSITION__CONDITION, oldCondition, condition));
	}
	...
	public void setCount_delay(String newCount_delay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_DEFERRED_TRANSITION__COUNT_DELAY, oldCount_delay, count_delay));
	}
	...
	public void setEffect(String newEffect) {
		...
		effect = newEffect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_DEFERRED_TRANSITION__EFFECT, oldEffect, effect));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_DEFERRED_TRANSITION__CONDITION:
				return getCondition();
...
} //InternalDeferredTransitionImpl
