...
public class SuspensionEContentAdapter extends EContentAdapter implements CincoEContentAdapter {
  @Override
  public void notifyChanged(final Notification notification) {
    super.notifyChanged(notification);
    final Object o = notification.getNotifier();
    final Object feature = notification.getFeature();
    if ((o instanceof InternalSuspension)) {
      if ((Objects.equal(((InternalSuspension)o).eContainer(), null) && (!(o instanceof InternalGraphModel)))) {
        return;
      }
      ...
      if (feature instanceof EStructuralFeature) {
        ...
        if (_isRelevant) {
          _matched=true;
          ModelElement _element = ((InternalSuspension)o).getElement();
          String _name = ((EStructuralFeature)feature).getName();
          Object _oldValue = notification.getOldValue();
          final PostAttributeChangePayload<Suspension> eventPayload = new PostAttributeChangePayload<Suspension>(((Suspension) _element), _name, _oldValue);
          final PayloadContext<PostAttributeChangePayload<Suspension>, Void> eventContext = new PayloadContext<PostAttributeChangePayload<Suspension>, Void>("event.post.attributeChange.info_scce_cinco_product_scchart_mglid_scchart_Suspension", eventPayload);
          EventHub.getInstance().notifyFirst(eventContext);
          ModelElement _element_1 = ((InternalSuspension)o).getElement();
